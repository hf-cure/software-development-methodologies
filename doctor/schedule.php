...
<body>
    ...
    $session_count = $list110->num_rows;
        ...
        <div class="dash-body">
            <div class="nav-bar">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <p style="font-size: 23px; font-weight: 600; margin: 0;">Session Manager</p>
            ...
            <div class="session-header">
                <h3>My Sessions</h3>
                <h1>Manage Your Consultation Times</h1>
                <p>View, track, and manage all your scheduled sessions in one place.<br>You can filter sessions by date to find specific schedules.</p>
            </div>

            <div style="margin-top: 30px;">
                <p style="font-size: 20px; font-weight: 600; margin-bottom: 20px;">My Sessions (<?php echo $session_count; ?>)</p>
                            ...
                            <tr>
                                ...
                                <td width="30%" style="text-align: right;">
                                    ...
                                    <?php if(isset($_POST['filter'])): ?>
                                        <a href="schedule.php" class="btn btn-primary-soft" style="margin-left: 10px;">Reset</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    echo '<tr>
                                        <td colspan="4">
                                            <center>
                                                ...
                                                <p style="font-size: 18px; font-weight: 500; color: #555;">No sessions found matching your criteria</p>
                                                <a href="schedule.php" class="btn btn-primary-soft" style="margin-top: 10px; margin-bottom: 30px;">Show All Sessions</a>
                                            </center>
                                        </td>
                                    </tr>';
                                } else {
                                    for ($x=0; $x<$result->num_rows; $x++){
                                        ...
                                        echo '<tr>
                                            <td style="font-weight: 600;">'.substr($title,0,30).'</td>
                                            <td>'.substr($scheduledate,0,10).' @ '.substr($scheduletime,0,5).'</td>
                                            <td style="text-align: center; font-size: 20px; font-weight: 500; color: #ff5722;">'.$nop.'</td>
                                            <td>
                                                <div style="display:flex;justify-content:center;gap:10px;">
                                                    <a href="?action=view&id='.$scheduleid.'" class="btn btn-primary-soft" style="padding: 9px 15px; border-radius: 10px;">
                                                        <i class="fas fa-eye" style="margin-right: 5px;"></i> View
                                                    </a>
                                                    <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="btn btn-primary-soft" style="padding: 9px 15px; border-radius: 10px;">
    ...
    if(isset($_GET['action'])){
        ...
        if($action == 'drop'){
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        ...
                        <div class="content">
                            Are you sure you want to cancel this session?<br><br>
                            <b>Session:</b> '.substr($nameget, 0, 40).'<br><br>
                        </div>
                        <div style="display: flex; justify-content: center; gap: 20px;">
                            <a href="delete-session.php?id='.$id.'" class="btn btn-primary">Yes, Cancel</a>
                            <a href="schedule.php" class="btn btn-primary-soft">No, Keep</a>
                        </div>
                    </center>
                </div>
            </div>';
            ...
            $current_patients = $result12->num_rows;
                    ...
                    <center>
                        ...
                        <div class="content" style="text-align: left; margin-top: 20px;">
                            <div style="padding: 20px; background-color: #f8f9fa; border-radius: 10px; margin-bottom: 20px;">
                                <p style="margin-bottom: 10px;"><b>Session Title:</b> '.$title.'</p>
                                <p style="margin-bottom: 10px;"><b>Doctor:</b> '.$docname.'</p>
                                <p style="margin-bottom: 10px;"><b>Scheduled Date:</b> '.$scheduledate.'</p>
                                <p style="margin-bottom: 10px;"><b>Scheduled Time:</b> '.$scheduletime.'</p>
                                <p><b>Maximum Bookings:</b> '.$nop.'</p>
                            </div>
                            
                            <p style="font-size: 18px; font-weight: 600; margin-bottom: 15px;">
                                Patients Registered: 
                                <span style="color: #ff5722;">'.$current_patients.'/'.$nop.'</span>
                            </p>
                            
                            <div class="scroll" style="max-height: 300px; background-color: white; padding: 15px; border-radius: 10px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08);">
                                <table width="100%" class="sub-table scrolldown" border="0">
                                    <thead>
                                        <tr>   
                                    ...
                                    if($current_patients == 0){
                                        echo '<tr>
                                            <td colspan="4">
                                                <center>
                                                    <img src="../img/notfound.svg" width="25%" style="margin-top: 30px; margin-bottom: 20px;">
                                                    <p style="font-size: 18px; font-weight: 500; color: #555;">No patients registered yet</p>
                                                </center>
                                            </td>
                                        </tr>';
                                    } else {
